...
contract NFTMarketplace is ERC721URIStorage {
    ...
    //Turns a tokenURI into an NFT and lists it on the marketplace
    ...
    // Transfer the NFT to the buyer, the funds to the seller and the listing fee to the marketplace creator
